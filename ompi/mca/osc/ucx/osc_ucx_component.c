...
static int component_open(void) {
    ...
    opal_common_ucx_add_features(UCP_FEATURE_RMA | UCP_FEATURE_AMO32 | UCP_FEATURE_AMO64);
...
static int component_init(bool enable_progress_threads, bool enable_mpi_threads) {
    ...
    mca_osc_ucx_component.wpool = NULL;
...
static int component_set_priority() {
    ...
    mca_osc_ucx_component.wpool = opal_common_ucx_global_wpool_get(
        mca_osc_ucx_component.enable_mpi_threads, ompi_proc_world_size());
