...
static inline ucc_status_t mca_coll_ucc_allreduce_init_common(const void *sbuf, void *rbuf,
                                                               size_t count,
                                ...
                                mca_coll_base_module_t *module)
{
    ...
    (void) info;
    UCC_VERBOSE(3, "running ucc allreduce_init");
...
fallback:
    ...
    return mca_coll_ucc_call_previous(allreduce_init, ucc_module,
        sbuf, rbuf, count, dtype, op, comm, info, request);
}
